...
export let useChapterLabelsStore: Writable<boolean> = writable<boolean>(false)
export let useSectionVisualSeparatorStore: Writable<boolean> = writable<boolean>(false)
export let usePrinceStore: Writable<boolean> = writable<boolean>(true)
export let useTwoColumnLayoutForTnNotesStore: Writable<boolean> = writable<boolean>(false)
export let useTwoColumnLayoutForTqNotesStore: Writable<boolean> = writable<boolean>(false)
export let showTnBookIntroStore: Writable<boolean> = writable<boolean>(true)
export let showTnChapterIntroStore: Writable<boolean> = writable<boolean>(true)
export let showBcBookIntroStore: Writable<boolean> = writable<boolean>(true)
export let showBcChapterCommentaryStore: Writable<boolean> = writable<boolean>(true)
export let showRgChapterCommentaryStore: Writable<boolean> = writable<boolean>(true)
